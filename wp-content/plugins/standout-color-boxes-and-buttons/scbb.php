...
*/
	...
	?>
		<div class="wrap">
			<h2 id="plugintitle"><img src="<?php echo plugins_url(scbb_get_path() . '/images/colors.png'); ?>" title="" alt="" height="64" width="64" align="absmiddle" /> <?php echo SCBB_PLUGIN_NAME; ?> by <a href="http://www.jimmyscode.com/">Jimmy Pe&ntilde;a</a></h2>
			...
			<h3 id="settings"><img src="<?php echo plugins_url(scbb_get_path() . '/images/settings.png'); ?>" title="" alt="" height="61" width="64" align="absmiddle" /><?php _e('Plugin Settings', scbb_get_local()); ?></h3>
			...
			<td><input type="checkbox" id="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_ENABLED_NAME; ?>]" name="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_ENABLED_NAME; ?>]" value="1" <?php checked('1', $options[SCBB_DEFAULT_ENABLED_NAME]); ?> /></td>
					</tr>
			<tr><td colspan="2"><?php _e('Is plugin enabled? Uncheck this to turn it off temporarily.', scbb_get_local()); ?></td></tr>
			...
			<td><select id="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_COLOR_NAME; ?>]" name="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_COLOR_NAME; ?>]">
					...
					echo '<option value="' . $color . '"' . selected($color, $options[SCBB_DEFAULT_COLOR_NAME], false)  . '>' . $color . '</option>';
												} ?>
							</select></td>
					</tr>
					<tr><td colspan="2"><?php _e('Select the built-in color you would like to use as the default.', scbb_get_local()); ?></td></tr>
					<tr valign="top"><th scope="row"><strong><label title="<?php _e('Use a custom color', scbb_get_local()); ?>" for="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_CUSTOMCOLOR_NAME; ?>]"><?php _e('Select custom color', scbb_get_local()); ?></label></strong></th>
						<td><input type="text" id="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_CUSTOMCOLOR_NAME; ?>]" name="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_CUSTOMCOLOR_NAME; ?>]" value="<?php echo $options[SCBB_DEFAULT_CUSTOMCOLOR_NAME]; ?>" class="scbb-color-picker" /></td>
					</tr>
					<tr valign="top"><td colspan="2"><?php _e('Select or enter a custom color to use by default. <strong>This will override the color selected above. Must be a hex color value such as #EEE or #FFCC00</strong>', scbb_get_local()); ?></td></tr>
			...
			<td><input type="checkbox" id="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_ROUNDED_NAME; ?>]" name="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_ROUNDED_NAME; ?>]" value="1" <?php checked('1', $options[SCBB_DEFAULT_ROUNDED_NAME]); ?> /></td>
					</tr>
			<tr valign="top"><td colspan="2"><?php _e('Check this box to use rounded corner CSS. You can override this at the shortcode level.', scbb_get_local()); ?></td></tr>
			...
			<td><input type="checkbox" id="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_SHADOW_NAME; ?>]" name="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_SHADOW_NAME; ?>]" value="1" <?php checked('1', $options[SCBB_DEFAULT_SHADOW_NAME]); ?> /></td>
					</tr>
			<tr valign="top"><td colspan="2"><?php _e('Check this box to use drop shadow CSS. You can override this at the shortcode level.', scbb_get_local()); ?></td></tr>
			...
			<td><input type="text" id="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_URL_NAME; ?>]" name="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_URL_NAME; ?>]" value="<?php echo $options[SCBB_DEFAULT_URL_NAME]; ?>" /></td>
					</tr>
			<tr valign="top"><td colspan="2"><?php _e('Enter default URL to use for color buttons. This URL will be used if you do not override it at the shortcode level.', scbb_get_local()); ?></td></tr>
			...
			<td><input type="checkbox" id="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_NOFOLLOW_NAME; ?>]" name="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_NOFOLLOW_NAME; ?>]" value="1" <?php checked('1', $options[SCBB_DEFAULT_NOFOLLOW_NAME]); ?> /></td>
					</tr>
			<tr valign="top"><td colspan="2"><?php _e('Check this box to add rel="nofollow" to button links only. You can override this at the shortcode level.', scbb_get_local()); ?></td></tr>
			...
			<td><input type="checkbox" id="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_NEWWINDOW_NAME; ?>]" name="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_NEWWINDOW_NAME; ?>]" value="1" <?php checked('1', $options[SCBB_DEFAULT_NEWWINDOW_NAME]); ?> /></td>
					</tr>
			<tr valign="top"><td colspan="2"><?php _e('Check this box to open links in a new window (color buttons only). You can override this at the shortcode level.', scbb_get_local()); ?></td></tr>
			...
			<td><textarea rows="12" cols="75" id="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_CUSTOM_CSS_NAME; ?>]" name="<?php echo scbb_get_option(); ?>[<?php echo SCBB_DEFAULT_CUSTOM_CSS_NAME; ?>]"><?php echo $options[SCBB_DEFAULT_CUSTOM_CSS_NAME]; ?></textarea></td>
			</tr>
			<tr valign="top"><td colspan="2"><?php _e('If you use your own custom class names, enter the CSS here. Include the "scbb-button" or "scbb-content-box" prefix in your CSS. In the shortcode or PHP, use the custom class name but DO NOT include the "scbb-button" or "scbb-content-box" prefix.', scbb_get_local()); ?>
			<br /><br /><?php _e('Example: If the custom CSS is <strong>.scbb-content-box-mycustomcolor { background-color:#FF9900 }</strong> then the shortcode is <br /><strong>[color-box color="mycustomcolor"]my text here[/color-box]</strong>', scbb_get_local()); ?>
			</td></tr>
			</table>
				<?php submit_button(); ?>
			<?php } elseif ($active_tab == 'parameters') { ?>
			<h3 id="parameters"><img src="<?php echo plugins_url(scbb_get_path() . '/images/parameters.png'); ?>" title="" alt="" height="64" width="64" align="absmiddle" /> <?php _e('Plugin Parameters and Default Values', scbb_get_local()); ?></h3>
			...
			<h3 id="examples"><img src="<?php echo plugins_url(scbb_get_path() . '/images/examples.png'); ?>" title="" alt="" height="64" width="64" align="absmiddle" /> <?php _e('Shortcode and PHP Examples', scbb_get_local()); ?></h3>
			<h4><?php _e('Shortcode Format (Color Boxes):', scbb_get_local()); ?></h4>
			<?php echo scbb_get_example_shortcode('color-box', scbb_colorbox_shortcode_defaults(), scbb_get_local()); ?>
			<h4><?php _e('Shortcode Format (Color Buttons):', scbb_get_local()); ?></h4>
			<?php echo scbb_get_example_shortcode('color-box', scbb_colorbutton_shortcode_defaults(), scbb_get_local()); ?>			
			...
			<?php } else { ?>
			<h3 id="support"><img src="<?php echo plugins_url(scbb_get_path() . '/images/support.png'); ?>" title="" alt="" height="64" width="64" align="absmiddle" /> <?php _e('Support', scbb_get_local()); ?></h3>
			<div class="support">
